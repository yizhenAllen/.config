  ...
  config = function()
    ...
    local on_attach = function(client, bufnr)
      ...
      keymap.set("n", "<leader>ld", "<cmd>Lspsaga show_line_diagnostics<CR>",
        { noremap = true, silent = true, buffer = bufnr, desc = "[L]ine [D]aignostic" })                                                                           -- show  diagnostics for line
      keymap.set("n", "<leader>cd", "<cmd>Lspsaga show_cursor_diagnostics<CR>",
        { noremap = true, silent = true, buffer = bufnr, desc = "[C]ursor [D]aignostic" })                                                                         -- show diagnostics for cursor
